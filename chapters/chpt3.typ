...
Ante estas limitaciones, en los últimos años se ha extendido el uso de modelos de aprendizaje automático supervisado para estimar indicadores ambientales y de biodiversidad a partir de variables predictoras de obtención más económica (datos climáticos, satelitales y edafológicos), reduciendo así la dependencia de mediciones directas exhaustivas sobre el terreno.
