...
#figure(
  ...
  #table(
    ...
    [*Índice de Shannon*],[Indica cuántas especies distintas hay en una muestra. Solo cuenta, no le importa si hay muchos individuos de una y pocos de otra.],
    [*Índice de riqueza*],[Mide la diversidad real de una muestra, combinando dos cosas: cuántas especies hay y cómo de repartidos están los individuos entre ellas. Si una especie domina casi todo y el resto apenas aparece, el índice es bajo aunque técnicamente haya varias especies. Si los individuos están repartidos de forma equilibrada entre muchas especies, el índice es alto. ],
