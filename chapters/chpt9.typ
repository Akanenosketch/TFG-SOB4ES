...
+ *Explorar posibles arquitecturas de aprendizaje profundo adicionales* como, por ejemplo, los modelos basados en _embeddings_ de imágenes satelitales descritos previamente en Antecedentes y contexto, una vez que se disponga de un mayor volumen de datos que permita mitigar de forma más eficiente el riesgo de sobreajuste ya existente a causa de la falta de datos.
